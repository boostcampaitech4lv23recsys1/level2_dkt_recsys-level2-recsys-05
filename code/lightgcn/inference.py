...
from lightgcn.datasets2 import prepare_dataset
from lightgcn.models2 import build, inference
...
def main():
    ...
    train_data, valid_data, test_data, n_node, offset = prepare_dataset(
        device, CFG.basepath, CFG.cate_cols, CFG.cont_cols, verbose=CFG.loader_verbose, logger=logger.getChild("data"),
        ratio=CFG.ratio
    )
